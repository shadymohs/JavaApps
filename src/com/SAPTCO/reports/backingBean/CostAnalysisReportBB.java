...
@ManagedBean(name="costAnalysisReportBB")
@ViewScoped
public class CostAnalysisReportBB extends ReportsBB{
	...
	protected ReportInfo getReportInfo() {
		if (costAnalysisReportDto.getIsSummary()  )
		    return  ReportInfo.Trip_daily_summary;
		else
			return  ReportInfo.Trip_daily_detail;
	}
	...
	protected Map<String, Object> getReportParameterMap(Map<String, Object> map)
		...
		if (costAnalysisReportDto.getIsSummary()  )
			map.put("SUBREPORT_DIR",costAnalysisReportDto.getGoingReturn()==1 ?
					context.getRealPath(SystemConstants.Trip_summary ) 
				  : context.getRealPath(SystemConstants.Trip_summary2 ));
		else
			
		   map.put("SUBREPORT_DIR",costAnalysisReportDto.getGoingReturn()==1 ?
				   context.getRealPath(SystemConstants.TripDetail)
				 : context.getRealPath(SystemConstants.TripDetail2));
