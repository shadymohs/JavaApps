package com.SAPTCO.lostLuggage.dao;
...
public interface LostLuggageDao {

	
	public List<LostLuggageClass> getLostLuggageClassList() throws Exception;
	//public LostLuggageClass  manageLuggageClass(LostLuggageClass luggageClass)  throws Exception;

	public List<LostLuggageSize> getLostLuggageSizeList() throws Exception ;
	//public LostLuggageSize  manageLuggageSize(LostLuggageSize luggageSize)  throws Exception;
	
	public List<LostLuggageColor> getLostLuggageColorList() throws Exception ;
	//public LostLuggageColor  manageLuggageColor(LostLuggageColor luggageColor)  throws Exception;
